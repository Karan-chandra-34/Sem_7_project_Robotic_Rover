...
//Group 7 Project- Robotic Rover with Camera
//This Wroom 32 (ESP 32) MCU is being used to control the Robotic Arm and is independent of ESP Cam 32 MCU - Rover controller
...
const char* ssid     = "Robotic Arm"; //This SSID will be displayed in the Mobile/Laptop available Network
...
// HTML WEBSITE code for controlling the Robotic Arm
...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">Robotic Rover for Space Exploration</h1>
